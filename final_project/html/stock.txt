...
$query = "SELECT b.book_id, b.book_name, (b.num_in_stock - od.quantity_ordered) as stock_left, b.publisher_num FROM 				Duck.Books b JOIN Duck.Order_details od ON b.book_id = od.book_id";

?>

<h2>Hi manager, the stock is as follow: </h2>
<?php
print $query;
?>
<?php
...
while($row = mysqli_fetch_array($result, MYSQLI_BOTH))
  {
    print "\n";
    print "Table: {$row[book_id]}    {$row[book_name]}    {$row[stock_left]}   {$row[publisher_num]} \n";
  }
print "</pre>";
